...
class BanniereController extends Controller
{
    ...
    public function index()
    {
        ...
        $slogans = Slogan::all();
        return view("backend.bannieres.table", compact("bannieres", "slogans"));
    }
    ...
    {
        return view("backend.bannieres.create");
    }
    ...
    {
        return view("backend.bannieres.editBanniere", compact("banniere"));
    }
