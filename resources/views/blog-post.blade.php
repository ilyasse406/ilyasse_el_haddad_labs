                    ...
                    <div class="single-post">
                        ...
                        <div class="post-content">
                            ...
                            <div class="post-meta">
                                ...
                                <a href="">@foreach ($show->tags as $tag)
									{{ $tag->name }},
								@endforeach</a>
                        ...
                        <div class="author">
                            <div class="avatar">
                                <img src="{{ asset("img/").'/'.$show->users->profile_photo_path }}"  alt="">
                            </div>
                        ...
                        <div class="comments">
                            ...
                            <ul class="comment-list">
                                @foreach ($show->commentaires as $i)
                                
                                <li>
                                    <div class="avatar">
                                        
                                        
                                        <img src="{{ asset("img/")."/".$i->users->profile_photo_path }}" alt="">
                                       
                                    </div>
                                    <div class="commetn-text">
                                        <h3>{{ $i->users->name }} | {{ $show->created_at->format("d") }} {{ $show->created_at->format("M") }}, {{ $show->created_at->format("Y") }} | Reply</h3>
                                        <p>{{$i->description}} </p>
                                    </div>
                                </li>
                                @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-9 comment-from">
                                ...
                                @if (Route::has('login'))
                                    ...
                                    @else
                                        <a href="{{ route('login') }}"
                                            class="text-sm text-gray-700 underline  px-2">Se connecter</a>
                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}"
                                                class="ml-4 text-sm text-gray-700 underline">S'inscrire</a>
                                        @endif
