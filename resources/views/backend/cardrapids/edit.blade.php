...
@section('content')
<div class="container">
    <form action="/admin/cardrapid/{{ $cardrapid->id }}" method="POST">
        @method("put")
        @csrf
        ...
        <select name="font" class="form-control mb-3" style="width: max-content; font-family: 'FontAwesome', 'Second Font name', 'FlatIcon';">
            
                {{-- <option value="far fa-address-card">&#xf2bb;</option>
                <option value="fas fa-user-md">&#xf0f0;</option>
                <option value="flaticon-001-picture">&#xf100;</option>
                <option value="flaticon-002-caliper">&#xf101;</option>
                <option value="flaticon-003-energy-drink">&#xf102;</option>
                <option value="flaticon-025-imagination">&#xf118;</option>
                <option value="flaticon-017-notebook">&#xf110;</option> --}}
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" name="title" value="{{ $cardrapid->title }}">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">description</label>
            <input type="text" class="form-control" id="exampleInputPassword1" name="description" value="{{ $cardrapid->description }}">
        </div>
