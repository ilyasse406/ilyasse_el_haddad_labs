                    ...
                    <div class="container text-center">
                        ...
                        <form action="/admin/user/ {{ Auth::user()->id }} " method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 pt-5 pr-5 pl-5">
                                ...
                                <input type="password" class="form-control" id="exampleInputPassword1" name="password" value="{{ Auth::user()->password }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Veuillez importer une image</label>
                                <input type="file"  id="exampleInputPassword1"
                                    name="profile_photo_path" value="{{ Auth::user()->profile_photo_path }}">
                            </div>
                            {{-- <div class="form-group">
